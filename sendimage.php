...
// Send image message (You must have a WhatsApp session enabled to send a message)	
...
curl_setopt($ch, CURLOPT_POSTFIELDS, "token=$token&cmd=$cmd&id=$id&to=$to&msg=$msg&link=$link");	
